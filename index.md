...
* 9. [接口定义](#接口定义)
    ...
    * 9.5. [矿机](#矿机)
        ...
        * 9.5.9. [获取子账户所属矿机的天在线情况](#获取子账户所属矿机的天在线情况)
...
**action:** Profit.GetAllUserPaymentByDay
...
####  9.5.9. <a name='获取子账户所属矿机的天在线情况'></a>获取子账户所属矿机的天在线情况

**action:** Worker.GetSubAccountWorkerDailyActiveNumList
